...
<?php endif; ?>
    ...
    <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        <div class="px-6 py-5 border-b border-gray-200 dark:border-gray-800">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white"><?php echo e($taxRate->exists ? 'Edit Tax Rate' : 'New Tax Rate'); ?></h3>
        </div>

        <form action="<?php echo e($taxRate->exists ? route('admin.tax-rates.update', $taxRate) : route('admin.tax-rates.store')); ?>"
              method="POST" class="p-6">
            <?php echo csrf_field(); ?> <?php if($taxRate->exists): ?> <?php echo method_field('PUT'); ?> <?php endif; ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <input type="text" name="country" value="<?php echo e(old('country', $taxRate->country)); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="region" value="<?php echo e(old('region', $taxRate->region)); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="label" value="<?php echo e(old('label', $taxRate->label)); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" min="0" max="100" name="rate"
                           value="<?php echo e(old('rate', $taxRate->rate)); ?>"
                           class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-900 placeholder:text-gray-400 focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 dark:border-gray-700 dark:text-white dark:placeholder:text-gray-500 dark:focus:border-brand-500">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="number" min="0" name="priority" value="<?php echo e(old('priority', $taxRate->priority)); ?>"
                           class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-900 placeholder:text-gray-400 focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 dark:border-gray-700 dark:text-white dark:placeholder:text-gray-500 dark:focus:border-brand-500">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex items-center">
                    <label class="relative inline-flex cursor-pointer items-center">
                        <input type="checkbox" name="is_active" value="1"
                               <?php echo e(old('is_active', $taxRate->is_active ?? true) ? 'checked' : ''); ?>
            ...
            <div class="flex gap-3 pt-4 border-t border-gray-200 dark:border-gray-800">
                <button type="submit"
                    ...
                    <?php echo e($taxRate->exists ? 'Update' : 'Create'); ?>
...
<?php echo $__env->make('admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\jdira\Herd\beautyshop\BeautyBackend\resources\views/admin/tax-rates/form.blade.php ENDPATH**/ ?>