...
<div style="padding: 24px;">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px;">
        <h1 style="font-size: 24px; font-weight: 700; color: #0f172a;">Slides</h1>
        <a href="{{ route('admin.slides.create') }}" style="padding: 8px 16px; background: #e11d48; color: #fff; border-radius: 8px; text-decoration: none; font-size: 14px; font-weight: 600;">+ New Slide</a>
    </div>
        ...
        <table style="width: 100%; border-collapse: collapse;">
            <thead>
                <tr style="background: #f8fafc; border-bottom: 1px solid #e2e8f0;">
                    ...
                    <th style="padding: 12px 16px; text-align: center; font-size: 12px; font-weight: 600; color: #64748b; text-transform: uppercase;">Active</th>
                ...
                @forelse ($slides as $slide)
                    <tr style="border-bottom: 1px solid #f1f5f9;">
                        ...
                        <td style="padding: 14px 16px; text-align: center;">
                            @if ($slide->is_active)
                                <span style="display: inline-block; padding: 2px 10px; background: #dcfce7; color: #166534; border-radius: 12px; font-size: 12px;">Active</span>
                            @else
                                <span style="display: inline-block; padding: 2px 10px; background: #fef2f2; color: #dc2626; border-radius: 12px; font-size: 12px;">Inactive</span>
                            @endif
                        </td>
                        <td style="padding: 14px 16px; text-align: center;">
                            <a href="{{ route('admin.slides.edit', $slide) }}" style="color: #e11d48; text-decoration: none; font-size: 13px; font-weight: 500;">Edit</a>
                        </td>
                    </tr>
                @empty
